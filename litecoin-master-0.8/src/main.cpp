...
uint256 hashGenesisBlock("0x41f3f2b62fbaf6fd42c4dda3aeea4f5e7f355bc2ef4d667a49e1cc75320dc1fa");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is is reduced by 50%  every 1 years
    nSubsidy >>= (nHeight / 210000); // tongbaocoin: 210k blocks in ~1 years
 if(nHeight == 1)
     {
       nSubsidy = 60000000 * COIN;	// 60 million coins, that all coins for not mine
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1448505000;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2159250;
